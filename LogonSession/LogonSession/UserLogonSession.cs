...
namespace LogonSession.LogonSession
{
    public class UserLogonSession
    {
        ...
        const string _log_target = "logon session";
        ...
        {
            Logger.WriteLine("Info", $"list up {_log_target}s");
            ...
            Logger.WriteLine("Info", $"found {list.Count} {_log_target}(s)");
            return list;
        }
        ...
        {
            Logger.WriteLine("Info", $"disconnect {_log_target} UserName:{UserName}, SessionID:{SessionID}, ProtocolType:{ProtocolType}");
        ...
        public bool Logoff()
        {
            Logger.WriteLine("Info", $"logoff {_log_target} UserName:{UserName}, SessionID:{SessionID}");
            nint serverHandle = PInvoke.WTSOpenServer(Environment.MachineName);
        ...
        {
            Logger.WriteLine("Info", $"check active {_log_target} UserName:{UserName}, SessionID:{SessionID}, SessionState:{SessionState}");
